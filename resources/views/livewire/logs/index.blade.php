    ...
    <div class="card overflow-hidden">
        ...
        <div class="flex flex-wrap items-center gap-x-4 gap-y-3 rounded-t-2xl bg-zinc-900 px-4 py-3 sm:px-5 dark:bg-zinc-950">
            ...
            <div class="ms-auto flex flex-wrap items-center gap-2">
                ...
                <div wire:loading wire:target="search, level" class="flex items-center gap-1.5 font-mono text-[11px] text-brand-400">
        ...
        @if($this->records->count())
            <div class="divide-y divide-zinc-100 dark:divide-zinc-800/70">
                @foreach($this->records as $log)
                    ...
                    @endphp
                    <div wire:key="log-{{ $loop->index }}" x-data="{ open: false }">
                        <button type="button" @click="open = !open"
                                class="flex w-full cursor-pointer items-start gap-3 px-4 py-3 text-start transition-colors hover:bg-zinc-50 sm:px-5 dark:hover:bg-zinc-800/50">
