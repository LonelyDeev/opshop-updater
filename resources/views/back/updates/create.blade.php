                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="card card-primary">
                            ...
                            <form id="updateForm" action="{{ route('admin.updates.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title"
                                               class="form-control"
                                               value="{{ old('title') }}"
                                               placeholder="مثال: نسخه 2.5.0 - اضافه شدن امکانات جدید" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" rows="6" class="form-control"
                                                  placeholder="توضیحات کامل درباره تغییرات..." required>{{ old('description') }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="release_date" id="release_date" class="form-control"
                                                       value="{{ old('release_date') }}" placeholder="1403/01/15">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-switch mt-4">
                                                    <input type="checkbox" name="is_mandatory" id="is_mandatory"
                                                           class="custom-control-input" value="1" {{ old('is_mandatory') ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="file" id="file"
                                                   class="custom-file-input" accept=".zip,.rar,.tar,.gz">
                                ...
                                <div class="card-footer">
                                    <button type="submit" id="submitBtn" class="btn btn-primary">
                                        ...
                                        <span class="btn-text">ذخیره آپدیت</span>
...
@push('scripts')
    <script>
        ...
        document.getElementById('updateForm').addEventListener('submit', function (e) {
            ...
            // CSRF از روی فیلد فرم خوانده می‌شود (داخل FormData هست)
            // اگر خواستی هدر هم بفرستی:
            ...
            xhr.onload = function () {
                ...
                if (xhr.status === 200 || xhr.status === 201) {
                    ...
                    alertBox.innerHTML =
                        '<div class="alert alert-success">' + (response.message || 'با موفقیت ذخیره شد.') + '</div>';
